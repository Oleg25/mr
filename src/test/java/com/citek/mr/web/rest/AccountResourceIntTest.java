...
import com.citek.mr.config.Constants;

import com.citek.mr.JoggingApp;
import com.citek.mr.domain.Authority;
import com.citek.mr.domain.PersistentToken;
import com.citek.mr.domain.User;
import com.citek.mr.repository.AuthorityRepository;
import com.citek.mr.repository.PersistentTokenRepository;
...
import com.citek.mr.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResourceIntTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@citek.com");
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.email").value("john.doe@citek.com"))
